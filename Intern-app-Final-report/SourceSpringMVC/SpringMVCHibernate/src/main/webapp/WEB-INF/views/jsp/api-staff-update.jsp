...
<body>
    ...
    <div class="col-md-4 col-md-offset-4">
      <form:form class="form-horizontal" action="${pageContext.request.contextPath}/rest/staff-update" method="POST" modelAttribute="staff">
        <fieldset>
          <!-- Form Name -->			
		 <div class="form-group">
            <label class="col-sm-2 control-label" for="textinput">ID</label>
            <div class="col-sm-10">
              <form:input type="text" path="id" value="${staff.id}" class="form-control" readonly="true"/>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <form:input type="text" path="username" value="${staff.username}" class="form-control" readonly="true"/>
            </div>
          </div>		
