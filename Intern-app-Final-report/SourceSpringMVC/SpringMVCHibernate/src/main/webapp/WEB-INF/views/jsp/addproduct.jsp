...
<body>
    ...
    <div class="col-md-4 col-md-offset-4">
      <form:form class="form-horizontal" action="${pageContext.request.contextPath}/saveProduct" method="POST" modelAttribute="product">
        <fieldset>
          <!-- Form Name -->
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <form:input type="text" path="id" placeholder="product's id" class="form-control"/>
            </div>
          </div>
